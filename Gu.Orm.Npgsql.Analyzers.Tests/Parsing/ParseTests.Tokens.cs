namespace Gu.Orm.Npgsql.Analyzers.Tests.Parsing
{
    ...
    public partial class ParseTests
    {
        public class Tokens
        {
            ...
            [TestCase("-- SELECT 'abc'", "SingleLineCommentTrivia: -- SELECT 'abc'")]
            [TestCase("-- SELECT 'abc'\r\nSELECT 1", "SingleLineCommentTrivia: -- SELECT 'abc' Identifier: SELECT Integer: 1")]
            [TestCase("/*\r\n-- SELECT 'abc'\r\n*/\r\nSELECT 1", "MultiLineCommentTrivia: /*\r\n-- SELECT 'abc'\r\n*/ Identifier: SELECT Integer: 1")]
